...
- `motion-tokens.ts` — shared GSAP timing, easing, snap-back tween options, and particle palette constants
- `snap-back-animations.ts` — cross-owner tile snap-back snapshot registry and clone animation helpers

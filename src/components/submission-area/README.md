...
- `SubmissionSlot` — single slot; empty = thin bordered drop target placeholder with centered flower, filled = shows character, removes on tap, draggable to other slots via GSAP Draggable

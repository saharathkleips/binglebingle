...
- `SubmissionSlot` — single slot; empty = thin bordered drop target placeholder with centered flower and solid tile-depth (no cast shadow), filled = shows character, removes on tap or outside-zone drop, draggable to other slots via GSAP Draggable

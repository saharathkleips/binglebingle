...
Reference full template: `/workspaces/binglebingle/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/binglebingle/.claude/get-shit-done/templates/state.md`.

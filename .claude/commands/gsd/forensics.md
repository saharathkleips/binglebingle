...
<execution_context>
@/workspaces/binglebingle/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/workspaces/binglebingle/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>

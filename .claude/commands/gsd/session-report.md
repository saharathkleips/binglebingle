...
<execution_context>
@/workspaces/binglebingle/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/workspaces/binglebingle/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
